...
public class AtlasSensorSuiteManager implements DRCSensorSuiteManager
{
   ...
   public void initializePhysicalSensors(URI rosCoreURI)
   {
      ...
      rosMainNode = new RosMainNode(rosCoreURI, "us/ihmc/atlas/sensorSuiteManager", true);
      ...
      {
         multisenseStereoVisionPointCloudPublisher = new StereoVisionPointCloudPublisher(modelFactory, ros2Node, PerceptionAPI.MULTISENSE_STEREO_POINT_CLOUD);
