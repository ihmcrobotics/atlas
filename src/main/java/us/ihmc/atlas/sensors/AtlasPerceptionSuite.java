...
public class AtlasPerceptionSuite extends PerceptionSuite
{
   ...
   private static final String directory = "/us/ihmc/atlas/src/main/resources/";
   ...
   public AtlasPerceptionSuite(Messager messager)
   {
      super(messager,
            ...
            Paths.get(rootPath.toString(), directory + REALSENSE_REA_MODULE_CONFIGURATION_FILE_NAME), "us/ihmc/atlas");
